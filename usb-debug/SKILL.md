...
gh api repos/qmk/qmk_firmware/contents/keyboards/<manufacturer>/<model>/keyboard.json --jq '.content' | base64 -d
gh api repos/qmk/qmk_firmware/contents/keyboards/<manufacturer>/<model>/config.h --jq '.content' | base64 -d
```
